...
import '../../Controller/login_controller_api.dart';
...
class _LoginState extends State<Login> {
  final login = Get.put(LoginControllerApi());
                                      ...
                                      EmailTextField(
                                        function: (value) {
                                          if (RegExp(
                                              ...
                                              .hasMatch(login.emailController.text)){
                                            return "Check your email.!";
                                          }
                                        },
                                        emailController: login.emailController,
                                      ),
