...
class GetStartedThird extends StatefulWidget {
  const GetStartedThird({super.key});

  @override
  State<GetStartedThird> createState() => _GetStartedThirdState();
}

class _GetStartedThirdState extends State<GetStartedThird> {
  @override
            ...
            child: Container(
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/get_started_third.png'),
                  fit: BoxFit.cover,
                ),
              ),
              child: Container(
