...
import 'package:shaadi_book/Controller/getprojectdata_controller_api.dart';
...
class EventScreen extends StatefulWidget {
  final eventId;
  EventScreen({super.key, required this.eventId});
...
class _EventScreenState extends State<EventScreen> {
  ...
  final getprojectdata = Get.put(GetProjectDataController());
  @override
  void initState() {
    super.initState();
  }
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    if (widget.eventId[data[index]['event']] != 0 &&
                        widget.eventId[data[index]['event']] != null) {
                      return EventItem(
                        event: data[index]["event"].toString(),
                        image: data[index]["image"].toString(),
                        id: int.parse(data[index]['id'].toString()),
                        eventId: widget.eventId['project_code'],
                      );
                    }
                    return SizedBox();
                  },
  ...
  //           context,
  //           CupertinoPageRoute(
  //             builder: (context) => EventVideoAndAlbum(),
  //           ),
  //         );
  //       },
  //       child: Container(
